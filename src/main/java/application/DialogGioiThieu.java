...
public class DialogGioiThieu extends JDialog {
	...
	public DialogGioiThieu() {
		...
		JLabel lblnuXyRa = new JLabel(
				"*N\u1EBFu x\u1EA3y ra l\u1ED7i trong qu\u00E1 tr\u00ECnh s\u1EED d\u1EE5ng vui l\u00F2ng li\u00EAn h\u1EC7 \u0111\u1EBFn hotline 123456789");
		...
		txtArea.setText(
				"Phần mềm quản lý quán karaoke Ksing có các chức năng giúp người quản lý và nhân viên \ndễ dàng sử dụng cho công việc quản lý quán karaoke."
				+ "\n\nPhần mềm được viết cho nhân viên lễ tân và người quản lý của quán karaoke Ksing,\nkhông dùng cho khách hàng."
